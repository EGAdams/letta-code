...
class MonitorLed {
  ...
  setLedBackgroundColor(newColor: string) {
    this.classObject.background_color = newColor;
  }
  setLedTextColor(newColor: string) {
    this.classObject.color = newColor;
  }
  setLedText(newText: string) {
