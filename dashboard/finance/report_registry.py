...
REPORT_MONTHS: tuple[ReportMonth, ...] = (
    ...
    ReportMonth(key='jun-2025', folder='june',
                start='2025-06-01', end='2025-06-30'),
    ReportMonth(key='jul-2025', folder='july',
                start='2025-07-01', end='2025-07-31'),
    ReportMonth(key='aug-2025', folder='august',
                start='2025-08-01', end='2025-08-31'),
    ReportMonth(key='sep-2025', folder='september',
                start='2025-09-01', end='2025-09-30'),
    ReportMonth(key='oct-2025', folder='october',
                start='2025-10-01', end='2025-10-31'),
    ReportMonth(key='nov-2025', folder='november',
                start='2025-11-01', end='2025-11-30'),
    ReportMonth(key='dec-2025', folder='december_2025',
